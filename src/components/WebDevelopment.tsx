...
export default function WebDevelopment() {
  return (
    <section
      id="paginas-web"
      className="relative overflow-hidden bg-primary-950 py-24"
    >
      <div className="absolute -left-20 top-20 h-96 w-96 rounded-full bg-secondary/15 blur-[120px]" />
      <div className="relative mx-auto max-w-7xl px-6">
        <SectionHeading
          ...
          title={
            <>
              Páginas web que{" "}
              <span className="text-gradient-blue">trabajan por ti</span>
            </>
          }
          subtitle="Sitios modernos, rápidos y diseñados para convertir visitantes en clientes."
        />
