...
**16. Portal del cliente con reportes**
- Qué hace: concentra evidencias, checklists y calendario de servicios en un enlace para el cliente
- Cuándo recomendarlo: justifica la renovación de contratos grandes y da imagen corporativa
- GHL: portal/enlace del cliente + entrega automática de evidencias por servicio

**17. Upsell de servicios especializados por temporada**
- Qué hace: ofrece automáticamente servicios extra (post-obra, sanitización, jardines) a contratos activos
- Cuándo recomendarlo: para subir el ticket de los clientes que ya tienes
- GHL: Campaign segmentada a contratos activos por temporada
...
| 14 | Voice AI | 🟪 |
| 15 | Reporte + alertas | 🟪 |
| 16 | Portal del cliente | ⭐ Extra |
| 17 | Upsell por temporada | ⭐ Extra |
